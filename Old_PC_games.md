I am compiling the following list of [PC games](https://en.wikipedia.org/wiki/PC_game) that using older [Direct3D](https://en.wikipedia.org/wiki/Direct3D) run perfectly on [Linux](https://en.wikipedia.org/wiki/Linux) with [Wine](https://www.winehq.org/) and [D7VK](https://github.com/WinterSnowfall/d7vk) implementations of [Windows](https://en.wikipedia.org/wiki/Microsoft_Windows) and [Direct3D](https://en.wikipedia.org/wiki/Direct3D) [APIs](https://en.wikipedia.org/wiki/API) on Linux respectively. The list is not an exhaustive. An introduction to [D7VK](https://github.com/WinterSnowfall/d7vk) can be found on this [Video](https://www.youtube.com/watch?v=cAkvOCfeLTk&t=22s). You could use [D7VK](https://github.com/WinterSnowfall/d7vk) when your old [Direct3D](https://en.wikipedia.org/wiki/Direct3D) game is not running properly with [Wine's](https://www.winehq.org/) buildin [Direct3D](https://en.wikipedia.org/wiki/Direct3D) aka WineD3D.

The following are tested against [D7VK](https://github.com/WinterSnowfall/d7vk) version 1.8 and newer and [Wine](https://www.winehq.org/) version 10.0 and newer. You need a pure 32-bit Wine prefix for some games to work. [Kron4ek](https://github.com/Kron4ek/Wine-Builds/releases) has some [Wine](https://www.winehq.org/) builts which can be downloaded and used with [Q4Wine](https://github.com/brezerk/q4wine), make sure you download wine-x-x86.tar.xz where x is the [Wine](https://www.winehq.org/) version. An introduction to [Q4Wine](https://github.com/brezerk/q4wine) is shown in this [video]([https://www.youtube.com/watch?v=vf9xZMQ7J2k&t=631s](https://www.youtube.com/watch?v=fOdxkFcCBB0&t)).

If you do not want to fiddle, you could simply use [Faugus Launcher](https://github.com/Faugus/faugus-launcher) and set ddraw to native,buildin in Winecfg. An introduction to [Faugus Launcher](https://github.com/Faugus/faugus-launcher) is shown in this [video](https://www.youtube.com/watch?v=vf9xZMQ7J2k&t=631s).
...
30.  [Twisted Metal 2](https://en.wikipedia.org/wiki/Twisted_Metal_2)
...
40.  [Delta Force: Land Warrior](https://en.wikipedia.org/wiki/Delta_Force:_Land_Warrior) - you can set ddraw.forceSWVP = True in the dxvk.conf file to fix the performance
...
46.  [Revenant](https://en.wikipedia.org/wiki/Revenant_(video_game))
